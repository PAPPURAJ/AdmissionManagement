...
import com.blogspot.duet.admissionmanagementsystem.admin.AdminMainActivity;
import com.blogspot.duet.admissionmanagementsystem.user.UserMainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void signUpClick(View view){
        ...
        final String name,mail,phone,stdID,pass;
        ...
        stdID=((EditText)findViewById(R.id.signup_stdIDEt)).getText().toString();
        pass=((EditText)findViewById(R.id.signup_passEt)).getText().toString().toLowerCase().replace(" ","");;
        

        if(name.equals("") || mail.equals("") || phone.equals("") || stdID.equals("") || pass.equals("")){
        ...
        mAuth.createUserWithEmailAndPassword(mail, pass)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        databaseReference.child("Users").push().setValue(new MyUserData(name,mail,phone,stdID,isAdmin));
                        progressSignup.setVisibility(View.INVISIBLE);
